...
export class TrinityCombat extends Combat {
  ...
  async rollInitiative(ids, {formula=null, updateTurn=true, messageOptions={}}={}) {
    ...
    for ( let id of iterations ) {
      ...
      // Trinity typically uses Cunning + a d10. 
      // We ensure it defaults to 0 if the attribute is missing to avoid NaN errors.
      ...
      // Update the combatant with the result in the tracker
      ...
      if ( messageOptions ) {
        await roll.toMessage({
          ...
          flavor: `${actor.name} focuses for Initiative!`,
          ...messageOptions
        });
      }
    }
