...
export class TrinityActorSheet extends ActorSheet {
  ...
  _prepareItems(context) {
    ...
    // Containers for Anima & Assassin items, plus new Deviations
    const aspects = [];
    const buffs = [];
    const masteries = [];
    const deviations = []; // Added deviations
    ...
    context.deviations = deviations; // Added deviations
  }
